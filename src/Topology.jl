...
function child_origin_internal2(parent_origin::Coord, child_index::Int)::Coord
    ...
    # Convert linear index to 3D offset within 32³ grid (OpenVDB: x*1024 + y*32 + z)
    iz = Int32(child_index % 32)
    iy = Int32((child_index ÷ 32) % 32)
    ix = Int32(child_index ÷ 1024)
...
function child_origin_internal1(parent_origin::Coord, child_index::Int)::Coord
    ...
    # Convert linear index to 3D offset within 16³ grid (OpenVDB: x*256 + y*16 + z)
    iz = Int32(child_index % 16)
    iy = Int32((child_index ÷ 16) % 16)
    ix = Int32(child_index ÷ 256)
