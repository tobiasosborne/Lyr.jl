...
@testset "Lyr.jl" begin
    ...
    include("test_fog_to_sdf.jl")
    include("test_particles_to_sdf.jl")
    include("test_particle_trails.jl")
    include("test_point_advection.jl")
    include("test_node_iteration.jl")
    include("test_segmentation.jl")
    include("test_meshing.jl")
    include("test_particle_field_enhanced.jl")
